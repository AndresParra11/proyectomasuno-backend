...
router.post('/user/getbyemail', UserCtrl.getUserByUMail)
...
router.get('/projectstitlesbyowner/:owner', ProjectCtrl.getProjectsTitlesByOwner)
router.get('/projectspresetsbyambient/:ambient', ProjectCtrl.getProjectsPresetsByAmbient)
